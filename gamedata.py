...
ITEM_DATA = {
    ...
    ItemType.COAL_ORE: {"name": "석탄", "color": (10, 10, 10), "value": 5, "fuel_value": 240, "desc": "연료 (8초)", "tile_image": "coal_ore_patch.png"},
    ...
    ItemType.CLASSIFIER: {"name": "분류기", "color": (200, 200, 0), "cost": 300, "is_building": True, "desc": "아이템을 필터링하여 좌/우로 보냅니다."},
...
ITEM_TO_BUILDING = {
    ...
    ItemType.CLASSIFIER: BuildingType.CLASSIFIER,
}
...
BUILDING_DATA = {
    ...
    BuildingType.CLASSIFIER: {"name": "분류기", "size": (1, 1), "has_dir": True, "image": "building_classifier.png"},
}
SHOP_ITEMS = [
